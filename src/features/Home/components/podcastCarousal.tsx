...
<div className="flex gap-10 overflow-x-auto pb-3
      ...
      ">
        {data.map((d,idx) => (
          <div className=" flex flex-row bg-white rounded-xl shadow-md min-w-[500px] " key={idx}>
            ...
            <div className="flex items-center justify-center mt-5 px-5 md:py-5 py-4 space-y-3 min-w-[50%]">
              ...
              <p className='lg:text-[16px] md:text-[14px]  font-semibold border-b-2 border-black'>{d.subTitle}</p>
